...
namespace  hanwenbo\rabbitmq;

use EasySwoole\Pool\MagicPool;
use EasySwoole\Pool\ObjectInterface;
use hanwenbo\rabbitmq\Config\RabbitMQChannelConfig;
use hanwenbo\rabbitmq\Config\RabbitMQConfig;
use hanwenbo\rabbitmq\Connection\AMQPConnection;
...
class RabbitMQChannelPool extends MagicPool
{
    function __construct(RabbitMQChannelConfig $channelConfig)
    {
        parent::__construct(function ()use($channelConfig) {
             ...
             */
            $channel = new \hanwenbo\rabbitmq\Connection\AMQPChannel($rabbitObj);
